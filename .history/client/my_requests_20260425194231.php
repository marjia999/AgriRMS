...
$requests_query = "SELECT sr.*, r.name as resource_name, r.model, r.daily_rate 
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <p>Track and manage your agricultural service requests</p>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size: 0.8rem; color: #888;">
                    <i class="fas fa-database"></i> Total: <?php echo $total; ?> requests
                </span>
            </div>
            <div class="table-responsive">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong><?php echo htmlspecialchars($row['resource_name'] ?? 'N/A'); ?></strong>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <a href="request_service.php" style="margin-top: 1rem; display: inline-block; color: #FF8C42; text-decoration: none;">
