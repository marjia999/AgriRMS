...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Calculate delivery fee based on division
                ...
                <form method="POST" id="requestForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_district" id="delivery_district" placeholder="e.g., Dhaka, Gazipur" oninput="calculateTotal()">
                        </div>
                        <div class="form-group">
