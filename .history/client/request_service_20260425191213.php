        ...
        <div class="container">
            ...
            <div class="form-card">
                ...
                <form method="POST" id="requestForm">
                    ...
                    <!-- ROW 2: Quantity + Delivery District -->
                    <div class="form-row">
                        <div class="form-group">
        ...
        function calculateTotal() {
            ...
            if (startDate && endDate && selectedResourceDaily > 0 && quantity <= selectedResourceQuantity) {
                ...
                if (end >= start) {
                    ...
                    if (rentalDuration === 'Daily') {
                        total = selectedResourceDaily * quantity;
                        formulaText = '৳ ' + selectedResourceDaily.toLocaleString() + ' × ' + quantity + ' unit(s)';
                    } else if (rentalDuration === 'Weekly') {
                        total = selectedResourceWeekly * quantity;
                        formulaText = '৳ ' + selectedResourceWeekly.toLocaleString() + ' × ' + quantity + ' unit(s)';
                    } else {
                        total = selectedResourceMonthly * quantity;
                        formulaText = '৳ ' + selectedResourceMonthly.toLocaleString() + ' × ' + quantity + ' unit(s)';
                    }
