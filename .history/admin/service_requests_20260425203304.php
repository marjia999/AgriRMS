            ...
            <div class="table-responsive">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><strong style="color: #1B4F2B;">#<?php echo str_pad($row['id'], 5, '0', STR_PAD_LEFT); ?></strong></td
                            <td>
                                <div>
                            ...
                            <td style="font-weight: 700; color: #FF8C42;">৳ <?php echo number_format($row['total_cost'], 2); ?></td
                            <td>
                                <?php
                            ...
                            <td><span style="font-size: 0.75rem;"><?php echo date('d M Y', strtotime($row['created_at'])); ?></span></td
                            <td>
