...
$resources = mysqli_query($conn, "SELECT * FROM resources ORDER BY type, name ASC");
...
<head>
    ...
    <style>
        * {
        ...
        /* Unit ID Badge - removed since no unit_id column, using ID instead */
        .unit-id {
            background: #1B4F2B;
            padding: 4px 12px;
            border-radius: 20px;
                        ...
                        <tr>
                            ...
                            <td class="price-cell">
                                <div class="price-wrapper">
                                    <span class="price-display">৳ <?php echo number_format($row['daily_rate'], 2); ?></span>
                                ...
                                <form method="POST" class="price-edit-form" id="price-form-<?php echo $row['id']; ?>">
                                    <input type="hidden" name="resource_id" value="<?php echo $row['id']; ?>">
                                    <input type="number" name="daily_rate" class="price-input" step="100" value="<?php echo $row['daily_rate']; ?>" placeholder="Daily Rate">
